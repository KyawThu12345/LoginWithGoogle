...
<?php endif; ?>
            ...
            <div>
                <a style="background-color:skyblue" href="<?php echo e(url('auth/google')); ?>">Login using Google</a>
            </div>
        </form>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\googlelogin\resources\views/auth/login.blade.php ENDPATH**/ ?>